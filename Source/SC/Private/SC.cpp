...
#include "UI/Styles/SCStyleSet.h"

//Custom implementation of the Default Game Module. 
class FSCGameModule : public FDefaultGameModuleImpl
{
	...
	{
		//Hot reload hack
		FSlateStyleRegistry::UnRegisterSlateStyle(FSCStyleSet::GetStyleSetName());
		FSCStyleSet::Initialize();
	}

	// Called whenever the module is shutting down. Here, we simply tell our MenuStyles to shut down.
	virtual void ShutdownModule() override
	{
		FSCStyleSet::Shutdown();
	}
};

IMPLEMENT_PRIMARY_GAME_MODULE( FSCGameModule, SC, "SC" );